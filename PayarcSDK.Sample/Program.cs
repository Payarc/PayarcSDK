					...
					case "applicationService":
						...
						switch (testApplicationAction) {
							case "createApplication":
								...
								BaseResponse createdApplication = await payarcAgent.ApplicationService.Create(merccandidate);
								Console.WriteLine($"Created Application: {createdApplication}");
								break;
							case "retrievApplication":
								BaseResponse retrievedApplication = await payarcAgent.ApplicationService.Retrieve(applicationId);
							...
							case "updateApplication":
								...
								var updatedApplication = await payarcAgent.ApplicationService.Update(applicationId, newApplicationData);
								Console.WriteLine($"Updated Application: {updatedApplication}");
								break;
							case "deleteApplication":
								// Delete a Application
								var deleted = await payarcAgent.ApplicationService.Delete(applicationId);
							...
							case "addDocument":
								...
								var documentAdded = await payarcAgent.ApplicationService.AddDocument(applicationId, merchantDocumentsData);
								Console.WriteLine($"Document Added Application: {documentAdded}");
								break;
							case "submitDocument":
								// Submit for signature
								var submitted = await payarcAgent.ApplicationService.Submit(applicationId);
								Console.WriteLine($"Submitted Applicant: {submitted}");
								break;
							case "deleteDocument":
								// Delete a document
								BaseResponse testApplication = await payarcAgent.ApplicationService.Retrieve(applicationId);
								...
								var deletedDocument = await payarcAgent.ApplicationService.DeleteDocument(applicationId, documentId);
							...
							case "listSubAgent":
                                ...
                                var subAgents = await payarcAgentWithSubAgent.ApplicationService.ListSubAgents(queryParamsSubAgents);
